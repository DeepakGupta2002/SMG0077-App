...
class StarlineTaskList : AppCompatActivity() {
    lateinit var backBUT: ImageView
    lateinit var singledigitImagV: LinearLayout
    lateinit var singlepanaImagV: LinearLayout
    lateinit var doublepanaImagV: LinearLayout
    lateinit var triplepanaImagV: LinearLayout
    ...
    private fun callwindow(gametype: String) {
        val intent = Intent(this, StarlineTaskBid::class.java)
