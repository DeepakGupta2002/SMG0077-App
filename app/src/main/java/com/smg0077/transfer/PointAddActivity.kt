...
import kotlinx.android.synthetic.main.activity_point_add.addpoint_whatappbut
import kotlinx.android.synthetic.main.activity_point_add.phonepe_note
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response


class PointAddActivity : AppCompatActivity() {
    ...
    lateinit var points_ED: EditText
...
//                        Log.d("TAG", "URL: $url")
                        ...
                        if (status.equals("true")) {
                            ...
                            phonepe_note.text = "-> $Google_upi_payment_id नंबर पर Phonepe, Paytm या GPay से पेमेंट करके स्क्रीनशॉट एडमिन को व्हाट्सप्प पर भेजे। "
